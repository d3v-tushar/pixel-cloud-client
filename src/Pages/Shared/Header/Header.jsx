...
const Header = ({darkMode, setDarkMode}) => {
  ...
  const linkCSS =
    "flex items-center mx-3 px-4 -mb-1 border-b-2 dark:border-transparent font-semibold font-mono";
  const active =
  ...
  return (
    <div className="navbar rounded-md">
      <div className="navbar-start">
        ...
        <Link to="/" className="bg-gradient-to-r from-yellow-600 via-yellow-400 to-yellow-700 bg-clip-text text-3xl font-extrabold text-transparent">
          Pixel Cloud
        </Link>
      </div>
